Feature: JMS REST API - Test Suite 3
  ...
  Scenario: Producing & Consuming Message
    ...
    And param destination = "queue://syed.input"
    And header Connection = "Keep-Alive"
    And request "Hi, Syed! Welcome to Karate - JMS"
    When method post
    Then status 200
    ...
    * waitForMiliseconds(1000)
    ...
    Given path "/api/message/syed.input"
    ...
    * print responseType
    * print response
    * match response contains "Hi, Syed! Welcome to Karate - JMS"
